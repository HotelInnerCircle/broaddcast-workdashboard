...
const TENANT_MODELS = { users: User, sessions: Session, invites: Invite, teams: Team, clients: Client, projects: Project, tasks: Task, taskComments: TaskComment, timeEntries: TimeEntry, breaks: Break, attendance: Attendance, workSites: WorkSite, attendanceSwipes: AttendanceSwipe, shifts: Shift, holidays: Holiday, leaveRequests: LeaveRequest, leavePolicies: LeavePolicy, dailyReports: DailyReport, conversations: Conversation, messages: Message, notifications: Notification, announcements: Announcement, subscriptions: Subscription, invoices: Invoice };
