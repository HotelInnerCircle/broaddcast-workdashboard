...
export const NOTIFICATION_TYPES = ["TASK_ASSIGNED", "TASK_COMPLETED", "TASK_OVERDUE", "TASK_COMMENT", "MENTION", "MESSAGE", "PROJECT_UPDATE", "DEADLINE", "TIMER", "ANNOUNCEMENT", "DAILY_REPORT", "ATTENDANCE_SWIPE"] as const;
